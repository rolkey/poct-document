...
CREATE TABLE lis_charge_item (
  ...
  standart_id VARCHAR(255),
  barcode_seq VARCHAR(255),
  charge_item_sort VARCHAR(255),
  charge VARCHAR(255),
  sample_class VARCHAR(255),
  patient_type VARCHAR(255),
  sampling_request VARCHAR(255),
  sampling_time VARCHAR(255),
  sampling_place VARCHAR(255),
  report_time VARCHAR(255),
  report_place VARCHAR(255),
  report_time_sort VARCHAR(255),
  inspection_time VARCHAR(255),
  workload VARCHAR(255),
  test_item_count VARCHAR(255),
  unite_flag VARCHAR(255),
  custom_code VARCHAR(255),
  spell_code VARCHAR(255),
  stroke_code VARCHAR(255),
  used_flag VARCHAR(255),
  state_flag VARCHAR(255),
  number_priority VARCHAR(255),
...
COMMENT ON COLUMN lis_charge_item.charge_item_sort IS '诊疗项目分类（免疫、生化、体液）';
...
CREATE TABLE lis_test_item (
  test_item_id BIGINT,
  test_item_code VARCHAR(255),
  test_item_sort VARCHAR(255),
  chinese_name VARCHAR(255),
  chinese_short_name VARCHAR(255),
  english_name VARCHAR(255),
  english_short_name VARCHAR(255),
  standard_id VARCHAR(255),
  his_id BIGINT,
  lis_id VARCHAR(255),
  medical_id VARCHAR(255),
  test_item_type VARCHAR(255),
  test_item_class VARCHAR(255),
  expressions VARCHAR(255),
  test_item_charge VARCHAR(255),
  test_item_unit VARCHAR(255),
  test_item_precision VARCHAR(255),
  modulus VARCHAR(255),
  correlative_equation VARCHAR(255),
  display_type VARCHAR(255),
  regulation_file VARCHAR(255),
  repository_file VARCHAR(255),
  test_method VARCHAR(255),
  reagent_dosage VARCHAR(255),
  custom_code VARCHAR(255),
  spell_code VARCHAR(255),
  stroke_code VARCHAR(255),
  state_flag VARCHAR(255),
