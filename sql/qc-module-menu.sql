...
(2053000000000000001, '质控管理', 0, 4, 'qc', NULL, NULL, 1, 0, 'M', '0', '0', NULL, 'checkbox', 103, 1, NOW(), 1, NOW(), '');

-- 质控品管理 (C)
INSERT INTO sys_menu (menu_id, menu_name, parent_id, order_num, path, component, query_param, is_frame, is_cache, menu_type, visible, status, perms, icon, create_dept, create_by, create_time, update_by, update_time, remark) VALUES
(2053000000000000002, '质控品管理', 2053000000000000001, 1, 'qcMaterial', 'qcMaterial', NULL, 1, 0, 'C', '0', '0', 'lis:qc:material:list', '', 103, 1, NOW(), 1, NOW(), '');
INSERT INTO sys_menu (menu_id, menu_name, parent_id, order_num, path, component, query_param, is_frame, is_cache, menu_type, visible, status, perms, icon, create_dept, create_by, create_time, update_by, update_time, remark) VALUES
...
-- 质控规则配置 (C)
INSERT INTO sys_menu (menu_id, menu_name, parent_id, order_num, path, component, query_param, is_frame, is_cache, menu_type, visible, status, perms, icon, create_dept, create_by, create_time, update_by, update_time, remark) VALUES
(2053000000000000003, '质控规则配置', 2053000000000000001, 2, 'qcRule', 'qcRule', NULL, 1, 0, 'C', '0', '0', 'lis:qc:rule:list', '', 103, 1, NOW(), 1, NOW(), '');
INSERT INTO sys_menu (menu_id, menu_name, parent_id, order_num, path, component, query_param, is_frame, is_cache, menu_type, visible, status, perms, icon, create_dept, create_by, create_time, update_by, update_time, remark) VALUES
...
-- 质控计划 (C)
INSERT INTO sys_menu (menu_id, menu_name, parent_id, order_num, path, component, query_param, is_frame, is_cache, menu_type, visible, status, perms, icon, create_dept, create_by, create_time, update_by, update_time, remark) VALUES
(2053000000000000004, '质控计划', 2053000000000000001, 3, 'qcPlan', 'qcPlan', NULL, 1, 0, 'C', '0', '0', 'lis:qc:plan:list', '', 103, 1, NOW(), 1, NOW(), '');
INSERT INTO sys_menu (menu_id, menu_name, parent_id, order_num, path, component, query_param, is_frame, is_cache, menu_type, visible, status, perms, icon, create_dept, create_by, create_time, update_by, update_time, remark) VALUES
...
-- 质控执行 (C)
INSERT INTO sys_menu (menu_id, menu_name, parent_id, order_num, path, component, query_param, is_frame, is_cache, menu_type, visible, status, perms, icon, create_dept, create_by, create_time, update_by, update_time, remark) VALUES
(2053000000000000005, '质控执行', 2053000000000000001, 4, 'qcExecution', 'qcRecord', NULL, 1, 0, 'C', '0', '0', 'lis:qc:execution:list', '', 103, 1, NOW(), 1, NOW(), '');
INSERT INTO sys_menu (menu_id, menu_name, parent_id, order_num, path, component, query_param, is_frame, is_cache, menu_type, visible, status, perms, icon, create_dept, create_by, create_time, update_by, update_time, remark) VALUES
...
-- 失控处理 (C)
INSERT INTO sys_menu (menu_id, menu_name, parent_id, order_num, path, component, query_param, is_frame, is_cache, menu_type, visible, status, perms, icon, create_dept, create_by, create_time, update_by, update_time, remark) VALUES
(2053000000000000006, '失控处理', 2053000000000000001, 5, 'qcOoc', 'qcOoc', NULL, 1, 0, 'C', '0', '0', 'lis:qc:ooc:list', '', 103, 1, NOW(), 1, NOW(), '');
INSERT INTO sys_menu (menu_id, menu_name, parent_id, order_num, path, component, query_param, is_frame, is_cache, menu_type, visible, status, perms, icon, create_dept, create_by, create_time, update_by, update_time, remark) VALUES
...
-- 一致性比对 (C)
INSERT INTO sys_menu (menu_id, menu_name, parent_id, order_num, path, component, query_param, is_frame, is_cache, menu_type, visible, status, perms, icon, create_dept, create_by, create_time, update_by, update_time, remark) VALUES
(2053000000000000007, '一致性比对', 2053000000000000001, 6, 'qcComparison', 'qcComparison', NULL, 1, 0, 'C', '0', '0', 'lis:qc:comparison:list', '', 103, 1, NOW(), 1, NOW(), '');
INSERT INTO sys_menu (menu_id, menu_name, parent_id, order_num, path, component, query_param, is_frame, is_cache, menu_type, visible, status, perms, icon, create_dept, create_by, create_time, update_by, update_time, remark) VALUES
...
-- 室间质评 (C)
INSERT INTO sys_menu (menu_id, menu_name, parent_id, order_num, path, component, query_param, is_frame, is_cache, menu_type, visible, status, perms, icon, create_dept, create_by, create_time, update_by, update_time, remark) VALUES
(2053000000000000008, '室间质评', 2053000000000000001, 7, 'qcEqa', 'qcEqa', NULL, 1, 0, 'C', '0', '0', 'lis:qc:eqa:list', '', 103, 1, NOW(), 1, NOW(), '');
INSERT INTO sys_menu (menu_id, menu_name, parent_id, order_num, path, component, query_param, is_frame, is_cache, menu_type, visible, status, perms, icon, create_dept, create_by, create_time, update_by, update_time, remark) VALUES
...
-- 质控报表 (C)
INSERT INTO sys_menu (menu_id, menu_name, parent_id, order_num, path, component, query_param, is_frame, is_cache, menu_type, visible, status, perms, icon, create_dept, create_by, create_time, update_by, update_time, remark) VALUES
(2053000000000000009, '质控报表', 2053000000000000001, 8, 'qcReport', 'qcReport', NULL, 1, 0, 'C', '0', '0', 'lis:qc:report:view', '', 103, 1, NOW(), 1, NOW(), '');
INSERT INTO sys_menu (menu_id, menu_name, parent_id, order_num, path, component, query_param, is_frame, is_cache, menu_type, visible, status, perms, icon, create_dept, create_by, create_time, update_by, update_time, remark) VALUES
